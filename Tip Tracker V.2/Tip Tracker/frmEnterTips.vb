...
Public Class frmEnterTips
    ...
    Private Sub LoadServerCombos()
        ...
        dvTemp.Sort = "FirstName, LastName"
    ...
    Private Sub mnuEditCCTip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuEditCCTip.Click
        If Me.CreditCardDataGridView.Rows.Count = 0 Then Exit Sub
    ...
    Private Sub mnuEditRCTip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuEditRCTip.Click
        If Me.RoomChargeDataGridView.Rows.Count = 0 Then Exit Sub
    ...
    Private Sub mnuEditCATip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuEditCATip.Click
        If Me.CashDataGridView.Rows.Count = 0 Then Exit Sub
    ...
    Private Sub mnuEditSFTip_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuEditSFTip.Click
        If Me.SpecialFunctionDataGridView.Rows.Count = 0 Then Exit Sub
        ...
        If frmEditTip.TipType = "Special Function" Then
            For Each row As DataRow In Me.FileDataSet.SpecialFunctions
                frmSelectFunction.cboFunctions.Items.Add(row("Specialunction").ToString)
            Next
        ...
        drNewRow("Description") = strNewDescription
        If strNewDescription = "Special Function" Then
            drNewRow("Specialunction") = strFunction
        End If
        drNewRow("WorkingDate") = dteNewDate
    ...
    Private Sub mnuOptimizeFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuOptimizeFile.Click
        If MessageBox.Show("This function will remove all servers who do not have tips.  It is recommended that this function" & _
        " only be performed after the pay period is balanced and all reports have been printed.  Optimization may take several" & _
        " minutes depending on the number of servers in the file.  Do you wish to continue?", "Optimize File", _
