Public Class frmAddEditServer
    ...
    Private Sub frmAddEditServer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        txtServerNumber.TabStop = Not (txtServerNumber.ReadOnly)
    End Sub
End Class