Public Class frmManageServers
    ...
    Private Sub frmManageServers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.ServersDataGridView.Columns("NoChit").DataPropertyName = frmMain.GlobalDataSet.Servers.Columns("SuppressChit").ColumnName
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Dim blnSuppressChit As Boolean = CBool(frmMain.GlobalDataSet.Servers.FindByServerNumber(strServerNumber)("SuppressChit"))
        ...
        With frmAddEditServer
            ...
            frmMain.GlobalDataSet.Servers.FindByServerNumber(strServerNumber)("SuppressChit") = .SuppressChit
