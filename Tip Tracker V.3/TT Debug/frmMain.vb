...
Public Class frmMain
    ...
    Private Sub btnForceGlobalFileReset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnForceGlobalFileReset.Click
        ...
        Try
            My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\Software\MJB\TipTracker\", "GlobalFile", "")
        Catch ex As Exception
            MessageBox.Show("The global file could not be reset.  You must reset the file manually", "Error Resetting File", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End Try

        MessageBox.Show("The global file path has removed.  Please use Tip Tracker to set the new path.", "Operation Complete", MessageBoxButtons.OK)
    End Sub
End Class